...
export const DocsPanel: FC = () => {
  ...
  return (
    <SidePanel
      className="bg-surface-base top-[var(--header-height)] h-[calc(100dvh-var(--header-height))] w-screen max-w-none rounded-none sm:max-w-[520px] sm:rounded-l-2xl"
      open={isOpen}
  ...
  "${baseUrl}/v1/jobs/async/job/$JOB_ID/stream"`}
        ...
        <DocSection title="Clarifying Questions">
          <Text kind="body/regular/sm" className="text-subtle">
            ...
            minutes, Deep Research now continues with a skip response. Headless async job submission starts directly from the
            provided input.
          </Text>
        </DocSection>

...
class TestSubmitDeepResearchJob:
    ...
    async def test_submit_agent_job_passes_data_sources(self):
        ...
        # Tail args are available_documents, data_sources, auth_token, research_depth, resume_files, webhook_config.
        assert job_args[-5] == ["web_search"]
